...
public class App
{
	...
	static Map<String,Integer> DetailsOfConstructionWork;
	static PrintStream output =  new PrintStream(new FileOutputStream(FileDescriptor.out));
    static Double PrincipalIt ;
    static Double InterestForGivenRate;
    static Double TimePeroid;
    ...
    public static void main( String[] args )
    {
    	...
    	do {
    		...
    		case '1':  getInterestDetails();
    		      SimpleInterest simpleinterest = new SimpleInterest(PrincipalIt,InterestForGivenRate,TimePeroid);
    		      output.print("Simple Interest is "+ simpleinterest.getSimpleInterest()+"\n");
    		      break;
    		case '2': getInterestDetails();
    		      CompoundInterest compoundinterest = new CompoundInterest(PrincipalIt,InterestForGivenRate,TimePeroid);
    ...
    public static void getInterestDetails() {
    	...
    	output.print("Enter values PrincipalIt,InterestForGivenRate, TimePeroid\n");

    	PrincipalIt = scanner.nextDouble();
    	InterestForGivenRate = scanner.nextDouble();
    	TimePeroid = scanner.nextDouble();
    ...
    public static void getmoreDetails(){
    	...
    	DetailsOfConstructionWork = e.getDetailsOfConstructionWork();

    	Integer SerialNumber=1;


    	Set<Map.Entry<String,Integer>> Plans = e.getDetailsOfConstructionWork().entrySet();
